...
let mongoUri = `mongodb://${process.env.MONGO_PORT_27017_TCP_ADDR || "localhost"}:${process.env.MONGO_PORT_27017_TCP_PORT || "27017"}/${process.env.MONGO_PORT_27017_DB_NAME || "blank"}`;
...
function subscribeToConfig() {
    const updateConfig = (forceUpdate) => {
        return (data) => {
    ...
    wampClient.subscribe("config", updateConfig(process.env.NODE_ENV === "DEV"), updateConfig(true), (e) => {
