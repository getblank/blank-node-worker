...
class ClickHouse {
    constructor(_opts) {
        let url = process.env.CLICKHOUSE_ADDR ? `http://${process.env.CLICKHOUSE_ADDR}` : "http://localhost";
        let port = process.env.CLICKHOUSE_PORT ? process.env.CLICKHOUSE_PORT : 8123;
