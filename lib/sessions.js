...
class Sessions extends EventEmitter {
    constructor() {
        ...
        this.userScriptApi = {
            ...
            check: this.new.bind(this),
            delete: this.new.bind(this),
        };
    }
    ...
    check(apiKey, cb) {
        ...
        this.wampClient.call("session.check", cb, apiKey);
        return d;
    }
    ...
    delete(apiKey, cb) {
        ...
        this.wampClient.call("session.delete", cb, apiKey);
        return d;
    }
    ...
    new(userId, cb) {
        ...
        this.wampClient.call("session.new", cb, userId);
        return d;
    }
